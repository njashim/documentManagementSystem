...
namespace API.Tests
{
    ...
    public class DocumentControllerTests
    {
        ...
        private Mock<IRabbitMQService> _rabbitMQServiceMock; // Mock für IRabbitMQService
        ...
        public void SetUp()
        {
            ...
            _rabbitMQServiceMock = new Mock<IRabbitMQService>(); // Mock für RabbitMQService
            _controller = new DocumentController(_documentServiceMock.Object, _loggerMock.Object, _rabbitMQServiceMock.Object); // Übergabe des Mock-Objekts
        }
